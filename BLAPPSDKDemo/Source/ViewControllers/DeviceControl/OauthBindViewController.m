...
- (IBAction)queryOatuhBind:(id)sender {
    [[BLAccount sharedAccount] queryOauthBindInfo:^(BLBindInfoResult * _Nonnull result) {
...
- (void)sendDestroyCode{
        [[BLAccount sharedAccount] sendDestroyCodeWithPhoneOrEmail:@"13567165451" countryCode:@"0086" completionHandler:^(BLBaseResult * _Nonnull result) {
